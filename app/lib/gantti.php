...
class Gantti {
  ...
  function render() {
    ...
    // common styles    
    $cellstyle  = 'style="line-height: ' . $this->options['cellheight'] . 'px; height: ' . $this->options['cellheight'] . 'px;background-color:#FFF"';
    ...
    foreach($this->blocks as $i => $block) {
      $html[] = '<li class="gantt-label"><strong ' . $cellstyle . ' title="'.$block['label'].'"><b style="color:#000">' . $block['label'] . '</b></strong></li>';
    }
    $html[] = '</ul>';
    $html[] = '</aside>';
    ...
    foreach($this->blocks as $i => $block) {
      ...
      $html[] = '<span class="gantt-block' . $class . '" style="left: ' . $left . 'px; width: ' . $width . 'px; height: ' . $height . 'px"><strong class="gantt-block-label">' . round($days,2) . '</strong></span>';
      $html[] = '</li>';
